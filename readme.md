...
<p><span style="font-size:14px"><strong>ticksBetweenSplashCycle</strong></span><span style="font-size:12px;color:#8a8d91">&nbsp;&nbsp;default 100, min 1, max 72000</span><br><span style="font-size:13px">How many ticks in between splash changes when on the title screen. 1 second = 20 ticks</span></p>
</div>
<h2><br><br><br><img src="https://cdn.serilum.com/description/nameplate/showcase.svg" alt="Showcase" width="838" height="64"></h2>
<p><span style="font-size:14px">Here the splash text changes every 2 seconds:</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/cycle-title-screen-splash/a.webp" alt=""></picture></p>
</details>
<p>&nbsp;<br><span style="font-size:14px">The delay can be set to 1, but also maybe you shouldn't:</span></p>
<details><summary>Show Spoiler</summary>
<p><picture><img src="https://cdn.serilum.com/projects/cycle-title-screen-splash/b.webp" alt=""></picture></p>
</details>
